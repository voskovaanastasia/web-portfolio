...
const project = {
  ...
  intro: {
    ...
    body: (
      <>
        <strong>Online Doctor</strong> is a telemedicine platform connecting patients with
        doctors for remote consultations. Full case study copy coming soon — this page is the
        placeholder structure ready to be filled in.
      </>
    ),
  },
};
    ...
    <main className="flex flex-col bg-white">
      ...
      <div className="max-w-6xl mx-auto px-6 lg:px-8 w-full">
        ...
        <div className="pb-24 flex flex-col items-center gap-4">
          <ImagePlaceholder filename="online doctor case content (in progress)" className="w-full min-h-[320px]" />
